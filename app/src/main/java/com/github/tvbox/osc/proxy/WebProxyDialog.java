...
public class WebProxyDialog {
    ...
    protected void testProxyConnections() {
        ...
        OkHttpClient okHttpClient = OkGoHelper.getDefaultClient();
    ...
    public void showProxyConfigDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext, R.style.AppDialogBase);
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View contentView = inflater.inflate(R.layout.web_proxy_dialog, null);

        /*Helpers.fixShowKeyboard(
